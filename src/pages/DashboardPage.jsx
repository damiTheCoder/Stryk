        ...
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-3">
          <section className="lg:col-span-2 space-y-4">
            <div className="uniswap-card p-6">
              ...
              <div className="mt-4 grid grid-cols-3 gap-1 sm:grid-cols-3 sm:gap-3">
                ...
                <div className="flex flex-col items-center gap-1 sm:hidden">
                  <button className="w-14 h-14 rounded-full bg-emerald-600 text-white transition hover:bg-emerald-500 inline-flex items-center justify-center">
                    <ShieldCheck className="h-6 w-6" />
                  </button>
                  <span className="text-xs font-medium text-gray-700 dark:text-gray-300">Redeem</span>
                </div>
